...
class TowerGroup:
    ...
    def upgrade(self):
        ...
        if self.selected_tower.level < 5:  #若被選到的 Tower 的 level < 5, level+1
    ...
    def sell(self):
        ...
        self.__towers.remove(self.selected_tower)  #將被選到的 Tower 從 list 中移除
        self.selected_tower = None  #重置 self.selected_tower
        pass
